...
try:
    ...
    filename_to_lexer = [
        [['Makefile', 'makefile', 'Makefile.am', 'makefile.am', 'Makefile.in',
          'makefile.in'], QsciLexerMakefile],
    ]
...
import seascope.DialogManager
from seascope.view.FileContextView import *
...
class EditorViewBase(QsciScintilla):
    ...
    def setProperty(self, name, val):
        ...
        self.SendScintilla(QsciScintillaBase.SCI_SETPROPERTY,
    ...
    def getProperty(self, name):
        ...
        address_name_buffer = name_buff.buffer_info()[0]
        address_val_buffer = val_buff.buffer_info()[0]
        self.SendScintilla(QsciScintillaBase.SCI_GETPROPERTY,
                           address_name_buffer, address_val_buffer)
    ...
    def printPropertyAll(self):
        ...
        address_val_buffer = val_buff.buffer_info()[0]
        self.SendScintilla(QsciScintillaBase.SCI_PROPERTYNAMES, 0,
                           address_val_buffer)
        print('###>')
...
class EditorView(EditorViewBase):
    ...
    def __init__(self, parent=None):
        ...
        self.setCaretLineBackgroundColor(
            QtGui.QColor("#d4feff"))  # orig: EEF6FF
    ...
    def ed_settings_1(self):
        ...
        self.setFoldMarginColors(QtGui.QColor("#888888"),
                                 QtGui.QColor("#eeeeee"))
    ...
    def find_text(self, from_cursor, is_fw):
        ...
        if (from_cursor):
            if (is_fw):
                ...
                if (ed.ev.hasSelectedText()):
                    inx = inx - 1
            if ed.ev.findFirst(text, opt['re'], opt['cs'], opt['wo'], False,
                               is_fw, line, inx):
                return True
            if not DialogManager.show_yes_no(
        ...
        if ed.ev.findFirst(text, opt['re'], opt['cs'], opt['wo'], False, is_fw,
                           line, inx):
            return
